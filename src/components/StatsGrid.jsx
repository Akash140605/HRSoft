...
import { AlertTriangle, CheckCircle2, Users, Warehouse, ShieldAlert } from 'lucide-react';
  ...
  return (
    <section className="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-5">
      {items.map((item) => {
        ...
        return (
          <div key={item.title} className="card overflow-hidden border border-slate-200">
